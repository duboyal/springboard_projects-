...
tweets_data_path2 = 'tweetsETH1.txt'
...
tweets_data_path14 = 'tweetsETH12.txt'
tweets_data_path15 = 'tweetsETH13.txt'
tweets_data_path16 = 'tweetsETH14.txt'
tweets_data_path17 = 'tweetsETH15.txt'

tweets_data = []

for i in range(1,16):
    tweets_data_path = 'tweetsETH'i'.txt'
